...
PRINT_ERROR   =  printf "$@ $(subst $(TTEXALENS_HOME)/,,$(CURDIR)) $(ERROR_STRING)\n"   | $(PRETTY_3_COL) && printf "$(CMD)\n$$LOG\n" && false
PRINT_WARNING =  printf "$@ $(subst $(TTEXALENS_HOME)/,,$(CURDIR)) $(WARN_STRING)\n"    | $(PRETTY_3_COL) && printf "$(CMD)\n$$LOG\n"
PRINT_OK      =  printf "$@ $(subst $(TTEXALENS_HOME)/,,$(CURDIR)) $(OK_STRING)\n"      | $(PRETTY_3_COL)
PRINT_SUCCESS =  printf "$@ $(subst $(TTEXALENS_HOME)/,,$(CURDIR)) $(SUCCESS_STRING)\n" | $(PRETTY_3_COL)
