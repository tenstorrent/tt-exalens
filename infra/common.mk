...
PRINT_ERROR   =  printf "$@ $(subst $(TTLENS_HOME)/,,$(CURDIR)) $(ERROR_STRING)\n"   | $(PRETTY_3_COL) && printf "$(CMD)\n$$LOG\n" && false
PRINT_WARNING =  printf "$@ $(subst $(TTLENS_HOME)/,,$(CURDIR)) $(WARN_STRING)\n"    | $(PRETTY_3_COL) && printf "$(CMD)\n$$LOG\n"
PRINT_OK      =  printf "$@ $(subst $(TTLENS_HOME)/,,$(CURDIR)) $(OK_STRING)\n"      | $(PRETTY_3_COL)
PRINT_SUCCESS =  printf "$@ $(subst $(TTLENS_HOME)/,,$(CURDIR)) $(SUCCESS_STRING)\n" | $(PRETTY_3_COL)
