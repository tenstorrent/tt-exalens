...
set(TTEXALENS_PRIVATE_GIT_TAG "f9a32973839bbdbd8a329b913cd5192a0c840a51")
...
if (DOWNLOAD_TTEXALENS_PRIVATE)
    if (NOT EXISTS "$ENV{CPM_SOURCE_CACHE}/ttexalens_private")
        ...
        file(COPY "${CMAKE_CURRENT_LIST_DIR}/ttexalens_private_check.cmake"
            DESTINATION "${CMAKE_BINARY_DIR}/tt_exalens_private_check")

        file(WRITE "${CMAKE_BINARY_DIR}/tt_exalens_private_check/CMakeLists.txt" "cmake_minimum_required(VERSION 3.16)\ncmake_policy(VERSION 3.16)\ninclude(\${CMAKE_CURRENT_LIST_DIR}/ttexalens_private_check.cmake)")
        ...
        if(GIT_LFS_EXECUTABLE MATCHES "NOTFOUND")
            ...
            execute_process(
                COMMAND ${CMAKE_COMMAND} -B build -Wno-dev -DTTEXALENS_PRIVATE_GIT_REPOSITORY=${TTEXALENS_PRIVATE_GIT_REPOSITORY} -DTTEXALENS_PRIVATE_GIT_TAG=${TTEXALENS_PRIVATE_GIT_TAG}
            ...
            if(NOT TTEXALENS_PRIVATE_CHECK_RESULT EQUAL "0")
                message(WARNING "tt-lens-private project check failed with error code ${TTEXALENS_PRIVATE_CHECK_RESULT}. Continuing without it.")
                set(DOWNLOAD_TTEXALENS_PRIVATE OFF)
            endif()
        endif()
