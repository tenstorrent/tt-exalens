...
```
init_ttexalens(init_jtag: bool = False, noc_id: NocId = NocId.NOC0, use_4B_mode: bool = True, simulation_directory: str | None = None, noc_failover: bool = True, safe_mode: bool = True) -> Context
```
