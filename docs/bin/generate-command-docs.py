...
Description:
  This is a script for automatically generating markdown documentation for TTExaLens commands
...
class CmdPPrinter(SectionPPrinter):
    def __init__(self):
        """The pretty printer class for TTExaLens command documentation."""
        super().__init__()
