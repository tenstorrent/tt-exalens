...
class WormholeDevice(tt_device.Device):
    ...
    def read_config_field(self, name: str, config: dict, debug_tensix: TensixDebug, start: int = 0):
        config[name[start:]] = debug_tensix.read_tensix_register(name)
    ...
    def get_unpack_tile_descriptor(self, debug_tensix: TensixDebug) -> list[dict]:
        ...
        self.read_config_field("UNPACK_TILE_DESCRIPTOR0_blobs_per_xy_plane", tile_descriptor0, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR0_reserved_1", tile_descriptor0, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR0_x_dim", tile_descriptor0, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR0_y_dim", tile_descriptor0, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR0_z_dim", tile_descriptor0, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR0_w_dim", tile_descriptor0, debug_tensix, start)
        ...
        self.read_config_field("UNPACK_TILE_DESCRIPTOR1_blobs_per_xy_plane", tile_descriptor1, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR1_reserved_1", tile_descriptor1, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR1_x_dim", tile_descriptor1, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR1_y_dim", tile_descriptor1, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR1_z_dim", tile_descriptor1, debug_tensix, start)
        self.read_config_field("UNPACK_TILE_DESCRIPTOR1_w_dim", tile_descriptor1, debug_tensix, start)
    ...
    def get_unpack_config(self, debug_tensix: TensixDebug) -> list[dict]:
        ...
        self.read_config_field("UNPACK_CONFIG0_upsample_rate", unpack_config0, debug_tensix, start)
        ...
        self.read_config_field("UNPACK_CONFIG0_shift_amount", unpack_config0, debug_tensix, start)
        ...
        self.read_config_field("UNPACK_CONFIG0_fifo_size", unpack_config0, debug_tensix, start)
        ...
        self.read_config_field("UNPACK_CONFIG1_upsample_rate", unpack_config1, debug_tensix, start)
        ...
        self.read_config_field("UNPACK_CONFIG1_shift_amount", unpack_config1, debug_tensix, start)
        ...
        self.read_config_field("UNPACK_CONFIG1_fifo_size", unpack_config1, debug_tensix, start)
