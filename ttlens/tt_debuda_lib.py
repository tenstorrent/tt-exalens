...
from ttlens.tt_debuda_lib_utils import check_context, validate_addr, validate_device_id
from ttlens.tt_arc_dbg_fw import arc_dbg_fw_command as arc_dbg_fw_command_impl
from ttlens.tt_arc import load_arc_fw as load_arc_fw_impl
