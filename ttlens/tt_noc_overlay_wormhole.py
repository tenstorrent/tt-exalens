...
class NocOverlayRegistersState():
    ...
    def STREAM_REMOTE_DEST_WR_PTR(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[20:])[0]
    ...
    def STREAM_BUF_SIZE(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[28:])[0]
    ...
    def STREAM_MSG_INFO_PTR(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[32:])[0]
    ...
    def STREAM_PHASE_AUTO_CFG_PTR(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[48:])[0]
    ...
    def STREAM_MSG_SRC_IN_ORDER_FWD_NUM_MSGS(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[64:])[0]
    ...
    def STREAM_NEXT_RECEIVED_MSG_ADDR(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[76:])[0]
    ...
    def STREAM_NEXT_RECEIVED_MSG_SIZE(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[80:])[0]
    ...
    def STREAM_MSG_INFO_CLEAR(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[84:])[0]
    ...
    def STREAM_RD_PTR(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[96:])[0]
    ...
    def STREAM_MSG_INFO_WR_PTR(self) -> int:
        ...
        STREAM_NUM_MSGS_RECEIVED_INC_REG or STREAM_SOURCE_ENDPOINT_NEW_MSG_INFO_REG.
        """
        return struct.unpack_from('<I', self.__buffer[104:])[0]
    ...
    def STREAM_MSG_GROUP_ZERO_MASK_AND(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[152:])[0]
    ...
    def STREAM_MSG_INFO_FULL(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[156:])[0]
    ...
    def STREAM_MEM_BUF_SPACE_AVAILABLE_ACK_THRESHOLD(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[160:])[0]
    ...
    def STREAM_MSG_INFO_CAN_PUSH_NEW_MSG(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[164:])[0]
    ...
    def STREAM_MSG_GROUP_COMPRESS(self) -> int:
        ...
        Read-only.  Valid only for receiver endpoint streams.
        """
        return struct.unpack_from('<I', self.__buffer[168:])[0]
    ...
    def STREAM_REMOTE_DEST_TRAFFIC_PRIORITY(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[176:])[0]
    ...
    def STREAM_DEBUG_ASSERTIONS(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[184:])[0]
    ...
    def STREAM_NUM_MSGS_RECEIVED_IN_BUF_AND_MEM(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[188:])[0]
    ...
    def STREAM_LOCAL_SRC_MASK(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[192:])[0]
    ...
    def STREAM_RECEIVER_ENDPOINT_SET_MSG_HEADER(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[240:])[0]
    ...
    def STREAM_RECEIVER_MSG_INFO(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[512:])[0]
    ...
    def STREAM_BLOB_AUTO_CFG_DONE(self) -> int:
        ...
        Exists only in stream 0
        """
        return struct.unpack_from('<I', self.__buffer[936:])[0]
    ...
    def STREAM_REMOTE_DEST_BUF_START_HI(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[968:])[0]
    ...
    def STREAM_REMOTE_DEST_MSG_INFO_WR_PTR_HI(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[972:])[0]
    ...
    def STREAM_CURR_PHASE_BASE(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[976:])[0]
    ...
    def STREAM_PHASE_AUTO_CFG_PTR_BASE(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[980:])[0]
    ...
    def FIRMWARE_SCRATCH(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[988:])[0]
    ...
    def STREAM_SCRATCH(self) -> int:
        ...
        """
        return struct.unpack_from('<I', self.__buffer[992:])[0]
    ...
    def read_DRAM_WRITES__SCRATCH_1_PTR_LO(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 3, 0, 16)

    def read_REMOTE_DEST_BUF_SIZE_WORDS(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 4, 0, 17)

    def read_DRAM_WRITES__SCRATCH_1_PTR_HI(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 4, 0, 3)

    def read_STREAM_REMOTE_DEST_WR_PTR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 5, 0, 32)
    ...
    def read_STREAM_BUF_SIZE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 7, 0, 32)

    def read_STREAM_MSG_INFO_PTR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 8, 0, 32)
    ...
    def read_INCOMING_DATA_NOC(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 0, 1)

    def read_OUTGOING_DATA_NOC(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 1, 1)

    def read_REMOTE_SRC_UPDATE_NOC(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 2, 1)

    def read_LOCAL_SOURCES_CONNECTED(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 3, 1)

    def read_SOURCE_ENDPOINT(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 4, 1)

    def read_REMOTE_SOURCE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 5, 1)

    def read_RECEIVER_ENDPOINT(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 6, 1)

    def read_LOCAL_RECEIVER(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 7, 1)

    def read_REMOTE_RECEIVER(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 8, 1)

    def read_PHASE_AUTO_CONFIG(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 9, 1)

    def read_PHASE_AUTO_ADVANCE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 10, 1)

    def read_DATA_AUTO_SEND(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 11, 1)

    def read_NEXT_PHASE_SRC_CHANGE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 12, 1)

    def read_NEXT_PHASE_DEST_CHANGE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 13, 1)

    def read_DATA_BUF_NO_FLOW_CTRL(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 14, 1)

    def read_DEST_DATA_BUF_NO_FLOW_CTRL(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 15, 1)

    def read_REMOTE_SRC_IS_MCAST(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 16, 1)

    def read_NO_PREV_PHASE_OUTGOING_DATA_FLUSH(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 17, 1)

    def read_UNICAST_VC_REG(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 18, 3)

    def read_REG_UPDATE_VC_REG(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 10, 21, 3)
    ...
    def read_STREAM_PHASE_AUTO_CFG_PTR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 12, 0, 32)

    def read_STREAM_MCAST_END_X(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 13, 0, 6)

    def read_STREAM_MCAST_END_Y(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 13, 6, 6)

    def read_STREAM_MCAST_EN(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 13, 12, 1)

    def read_STREAM_MCAST_LINKED(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 13, 13, 1)

    def read_STREAM_MCAST_VC(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 13, 14, 1)

    def read_STREAM_MCAST_NO_PATH_RES(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 13, 15, 1)

    def read_STREAM_MCAST_XY(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 13, 16, 1)
    ...
    def read_MSG_ARB_GROUP_SIZE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 15, 0, 3)

    def read_MSG_SRC_IN_ORDER_FWD(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 15, 3, 1)

    def read_STREAM_MSG_SRC_IN_ORDER_FWD_NUM_MSGS(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 16, 0, 32)

    def read_MSG_HEADER_WORD_CNT_OFFSET(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 17, 0, 7)

    def read_MSG_HEADER_WORD_CNT_BITS(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 17, 7, 7)
    ...
    def read_STREAM_NEXT_RECEIVED_MSG_ADDR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 19, 0, 32)

    def read_STREAM_NEXT_RECEIVED_MSG_SIZE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 20, 0, 32)

    def read_STREAM_MSG_INFO_CLEAR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 21, 0, 32)
    ...
    def read_STREAM_NEXT_MSG_SEND(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 23, 0, 32)

    def read_STREAM_RD_PTR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 24, 0, 32)

    def read_STREAM_WR_PTR(self, device, location, stream_id) -> int:
    ...
    def read_STREAM_MSG_INFO_WR_PTR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 26, 0, 32)
    ...
    def read_SOURCE_ENDPOINT_NEW_MSG_ADDR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 29, 0, 17)

    def read_SOURCE_ENDPOINT_NEW_MSG_SIZE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 29, 17, 15)

    def read_SOURCE_ENDPOINT_NEW_MSGS_NUM(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 30, 0, 12)

    def read_SOURCE_ENDPOINT_NEW_MSGS_TOTAL_SIZE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 30, 12, 17)
    ...
    def read_WAIT_PREV_PHASE_DATA_FLUSH(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 35, 1, 1)

    def read_MSG_FWD_ONGOING(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 35, 2, 1)

    def read_STREAM_CURR_STATE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 35, 3, 4)

    def read_PHASE_NUM_INCR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 36, 0, 12)

    def read_CURR_PHASE_NUM_MSGS(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 36, 12, 12)

    def read_NEXT_PHASE_NUM_CFG_REG_WRITES(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 36, 24, 8)
    ...
    def read_CLOCK_GATING_HYST(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 37, 1, 7)

    def read_PARTIAL_SEND_WORDS_THR(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 37, 8, 8)

    def read_STREAM_MSG_GROUP_ZERO_MASK_AND(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 38, 0, 32)

    def read_STREAM_MSG_INFO_FULL(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 39, 0, 32)

    def read_STREAM_MEM_BUF_SPACE_AVAILABLE_ACK_THRESHOLD(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 40, 0, 32)

    def read_STREAM_MSG_INFO_CAN_PUSH_NEW_MSG(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 41, 0, 32)

    def read_STREAM_MSG_GROUP_COMPRESS(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 42, 0, 32)

    def read_MSG_LOCAL_STREAM_CLEAR_NUM(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 43, 0, 16)

    def read_MSG_GROUP_STREAM_CLEAR_TYPE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 43, 16, 1)

    def read_STREAM_REMOTE_DEST_TRAFFIC_PRIORITY(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 44, 0, 32)

    def read_DEBUG_STATUS_STREAM_ID_SEL(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 45, 0, 6)

    def read_DISABLE_DEST_READY_TABLE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 45, 6, 1)

    def read_STREAM_DEBUG_ASSERTIONS(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 46, 0, 32)

    def read_STREAM_NUM_MSGS_RECEIVED_IN_BUF_AND_MEM(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 47, 0, 32)

    def read_STREAM_LOCAL_SRC_MASK(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 48, 0, 32)

    def read_STREAM_RECEIVER_ENDPOINT_SET_MSG_HEADER(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 60, 0, 32)

    def read_REMOTE_DEST_WORDS_FREE(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 64, 0, 17)

    def read_STREAM_RECEIVER_MSG_INFO(self, device, location, stream_id) -> int:
        return device.get_stream_reg_field(location, stream_id, 128, 0, 32)
