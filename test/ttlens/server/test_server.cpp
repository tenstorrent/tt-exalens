...
std::unique_ptr<tt::ttlens::server> start_server(bool enable_yaml, int port = DEFAULT_TEST_SERVER_PORT) {
    auto server = std::make_unique<tt::ttlens::yaml_not_implemented_server>(enable_yaml);
...
TEST(ttlens_server, ping) {
    tt::ttlens::request request{tt::ttlens::request_type::ping};
...
TEST(ttlens_server, get_runtime_data) {
    test_not_implemented_request(tt::ttlens::request{tt::ttlens::request_type::get_runtime_data}, "- type: 101");
}

TEST(ttlens_server, get_cluster_description) {
    test_not_implemented_request(tt::ttlens::request{tt::ttlens::request_type::get_cluster_description}, "- type: 102");
}

TEST(ttlens_server, get_device_ids) {
    test_not_implemented_request(tt::ttlens::request{tt::ttlens::request_type::get_device_ids}, "- type: 18");
}

TEST(ttlens_server, pci_read32) {
    test_not_implemented_request(tt::ttlens::pci_read32_request{tt::ttlens::request_type::pci_read32, 1, 2, 3, 123456},
                                 "- type: 10\n  chip_id: 1\n  noc_x: 2\n  noc_y: 3\n  address: 123456");
}

TEST(ttlens_server, pci_write32) {
    test_not_implemented_request(
        tt::ttlens::pci_write32_request{tt::ttlens::request_type::pci_write32, 1, 2, 3, 123456, 987654},
        "- type: 11\n  chip_id: 1\n  noc_x: 2\n  noc_y: 3\n  address: 123456\n  data: 987654");
}

TEST(ttlens_server, pci_read) {
    test_not_implemented_request(tt::ttlens::pci_read_request{tt::ttlens::request_type::pci_read, 1, 2, 3, 123456, 1024},
                                 "- type: 12\n  chip_id: 1\n  noc_x: 2\n  noc_y: 3\n  address: 123456\n  size: 1024");
}

TEST(ttlens_server, pci_read32_raw) {
    test_not_implemented_request(tt::ttlens::pci_read32_raw_request{tt::ttlens::request_type::pci_read32_raw, 1, 123456},
                                 "- type: 14\n  chip_id: 1\n  address: 123456");
}

TEST(ttlens_server, pci_write32_raw) {
    test_not_implemented_request(
        tt::ttlens::pci_write32_raw_request{tt::ttlens::request_type::pci_write32_raw, 1, 123456, 987654},
        "- type: 15\n  chip_id: 1\n  address: 123456\n  data: 987654");
}

TEST(ttlens_server, dma_buffer_read32) {
    test_not_implemented_request(
        tt::ttlens::dma_buffer_read32_request{tt::ttlens::request_type::dma_buffer_read32, 1, 123456, 456},
        "- type: 16\n  chip_id: 1\n  address: 123456\n  channel: 456");
}
...
TEST(ttlens_server, get_device_arch) {
    test_not_implemented_request(tt::ttlens::get_device_arch_request{tt::ttlens::request_type::get_device_arch, 1},
                                 "- type: 19\n  chip_id: 1");
}

TEST(ttlens_server, get_device_soc_description) {
    test_not_implemented_request(
        tt::ttlens::get_device_soc_description_request{tt::ttlens::request_type::get_device_soc_description, 1},
        "- type: 20\n  chip_id: 1");
}

TEST(ttlens_server, jtag_read32) {
    test_not_implemented_request(tt::ttlens::jtag_read32_request{tt::ttlens::request_type::jtag_read32, 1, 2, 3, 123456},
                                 "- type: 50\n  chip_id: 1\n  noc_x: 2\n  noc_y: 3\n  address: 123456");
}

TEST(ttlens_server, jtag_write32) {
    test_not_implemented_request(
        tt::ttlens::jtag_write32_request{tt::ttlens::request_type::jtag_write32, 1, 2, 3, 123456, 987654},
        "- type: 51\n  chip_id: 1\n  noc_x: 2\n  noc_y: 3\n  address: 123456\n  data: 987654");
}

TEST(ttlens_server, jtag_read32_axi) {
    test_not_implemented_request(tt::ttlens::jtag_read32_axi_request{tt::ttlens::request_type::jtag_read32_axi, 1, 123456},
                                 "- type: 52\n  chip_id: 1\n  address: 123456");
}

TEST(ttlens_server, jtag_write32_axi) {
    test_not_implemented_request(
        tt::ttlens::jtag_write32_axi_request{tt::ttlens::request_type::jtag_write32_axi, 1, 123456, 987654},
        "- type: 53\n  chip_id: 1\n  address: 123456\n  data: 987654");
}
...
TEST(ttlens_server, get_buda_run_dirpath) {
    test_not_implemented_request(tt::ttlens::request{tt::ttlens::request_type::get_buda_run_dirpath}, "- type: 201");
}
