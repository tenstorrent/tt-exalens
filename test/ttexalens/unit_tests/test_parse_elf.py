...
def compile_test_cpp_program(program_path, program_text):
    ...
    # Run ./build/sfpi/compiler/bin/riscv32-tt-elf-g++ -g ./test-elf.c -o test-elf on the program_text
    import os
    ...
    # Compile the program
    os.system(f"./build/sfpi/compiler/bin/riscv32-tt-elf-g++ -g {src_file_name} -o {program_path}.elf")
