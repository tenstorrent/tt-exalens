...
./scripts/noc_to_python/codegen-noc-overlay-wormhole > ./ttexalens/hardware/wormhole/noc_overlay.py
./scripts/noc_to_python/codegen-noc-overlay-blackhole > ./ttexalens/hardware/blackhole/noc_overlay.py
