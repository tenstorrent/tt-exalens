...
parser.add_argument(
    "--enable", type=str, nargs="+", help="Enable specific tests by ID or name patterns (space separated)"
)
parser.add_argument(
    "--disable", type=str, nargs="+", help="Disable specific tests by ID or name patterns (space separated)"
)
