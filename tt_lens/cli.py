...
try:
    ...
    traceback.print_exc()
    print(f"Try:\033[31m pip install -r tt_lens/requirements.txt \033[0m")
    exit(1)


from tt_lens import tt_debuda_init
from tt_lens import tt_debuda_server
from tt_lens import tt_util as util
from tt_lens.tt_uistate import UIState
from tt_lens.tt_commands import find_command
from tt_lens.tt_gdb_server import GdbServer, ServerSocket
from tt_lens.tt_coordinate import OnChipCoordinate
from tt_lens.tt_debuda_context import Context

from tt_lens import Verbosity
