...
RISCV_SOURCE=tt_lens/riscv-src
...
# Define targets
.PHONY: tt_lens/riscv tt_lens/riscv/clean

$(RISCV_OBJECT): $(OUT)
	mkdir -p $@

tt_lens/riscv: $(RISCV_OBJECT) tt_lens/riscv/grayskull tt_lens/riscv/wormhole tt_lens/riscv/blackhole
...
tt_lens/riscv/$(1): $(foreach app,$(2),$(foreach core,$(3),$(RISCV_OUTPUT)/$(1)/$(app).$(core).elf))
endef
