...
from tt_lens.tt_object import TTObject
from tt_lens import tt_util as util
from tt_lens.tt_coordinate import OnChipCoordinate, CoordinateTranslationError
from collections import namedtuple
from abc import ABC, abstractmethod
from typing import Dict
from tt_lens.tt_debug_risc import get_risc_reset_shift, RiscDebug, RiscLoc
...
class Device(TTObject):
    ...
    def create(arch, device_id, cluster_desc, device_desc_path: str, context: Context):
        ...
        if arch.lower() == "grayskull":
            from tt_lens import tt_grayskull
        ...
        if "wormhole" in arch.lower():
            from tt_lens import tt_wormhole
        ...
        if "blackhole" in arch.lower():
            from tt_lens import tt_blackhole
