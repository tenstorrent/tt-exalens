...
class RiscDebug :
    ...
    def is_pc_watchpoint_hit(self):
        return (self.__riscv_read(REG_STATUS) & STATUS_PC_WATCHPOINT_HIT) == STATUS_PC_WATCHPOINT_HIT

    def is_memory_watchpoint_hit(self):
        return (self.__riscv_read(REG_STATUS) & STATUS_MEMORY_WATCHPOINT_HIT) == STATUS_MEMORY_WATCHPOINT_HIT
