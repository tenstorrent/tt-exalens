...
# GCC options
OPTIONS_ALL=-O0 -march=rv32imw -mtune=rvtt-b1 -mabi=ilp32 -std=c++17 -g -flto -ffast-math -mcmodel=medlow
...
dbd/riscv: $(RISCV_OBJECT) dbd/riscv/grayskull dbd/riscv/wormhole dbd/riscv/blackhole
...
dbd/riscv/$(1): $(foreach app,$(2),$(foreach core,$(3),$(RISCV_OUTPUT)/$(1)/$(app).$(core).elf))
endef
