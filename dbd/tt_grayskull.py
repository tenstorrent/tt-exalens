...
class GrayskullDevice (tt_device.Device):
    ...
    def row_count(self): return len(GrayskullDevice.DIE_Y_TO_NOC_0_Y)
    def no_tensix_row_count(self): return 2
    def no_tensix_col_count(self): return 1
    ...
    def read_stream_regs_direct(self, loc, stream_id):
        ...
        if local_sources_connected == 1:
            ...
            reg["STREAM_BUF_SPACE_AVAILABLE_REG_INDEX (word addr)"] = self.get_stream_reg_field(loc, stream_id, 27, 0, 16)
