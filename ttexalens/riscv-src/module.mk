...
OPTIONS_LINK=-fno-exceptions -Wl,-z,max-page-size=16 -Wl,-z,common-page-size=16 -nostartfiles -Lttexalens/riscv-src

# Define project paths
RISCV_SOURCE=ttexalens/riscv-src
...
# Define targets
.PHONY: ttexalens/riscv ttexalens/riscv/clean

$(RISCV_OBJECT): $(OUT)
	mkdir -p $@

ttexalens/riscv: $(RISCV_OBJECT) ttexalens/riscv/grayskull ttexalens/riscv/wormhole ttexalens/riscv/blackhole

ttexalens/riscv/clean:
	rm -rf $(RISCV_OBJECT)
	rm -rf $(RISCV_OUTPUT)
...
ttexalens/riscv/$(1): $(foreach app,$(2),$(foreach core,$(3),$(RISCV_OUTPUT)/$(1)/$(app).$(core).elf))
endef
