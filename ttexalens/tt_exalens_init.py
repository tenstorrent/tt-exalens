...
def init_ttexalens(
    ...
    return load_context(umd_api, FileAccessApi(), use_noc1=use_noc1, noc_failover=noc_failover, safe_mode=safe_mode)
...
def load_context(
    ...
    context = Context(umd_api, file_api, use_noc1=use_noc1, noc_failover=noc_failover, safe_mode=safe_mode)
