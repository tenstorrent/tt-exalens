...
register_map = {
    ...
    "ARC_RESET_SCRATCH0": ArcResetRegisterDescription(offset=0x060),
    "ARC_RESET_SCRATCH1": ArcResetRegisterDescription(offset=0x064),
    "ARC_RESET_SCRATCH2": ArcResetRegisterDescription(offset=0x068),
    "ARC_RESET_SCRATCH3": ArcResetRegisterDescription(offset=0x06C),
    "ARC_RESET_SCRATCH4": ArcResetRegisterDescription(offset=0x070),
    "ARC_RESET_SCRATCH5": ArcResetRegisterDescription(offset=0x074),
...
class WormholeArcBlock(WormholeNocBlock):
