...
niu_register_map = {
    ...
    "NOC_Y_ID_TRANSLATE_TABLE_0": NocConfigurationRegisterDescription(offset=0x28),
    "NOC_Y_ID_TRANSLATE_TABLE_1": NocConfigurationRegisterDescription(offset=0x2C),
    "NOC_Y_ID_TRANSLATE_TABLE_2": NocConfigurationRegisterDescription(offset=0x30),
    "NOC_Y_ID_TRANSLATE_TABLE_3": NocConfigurationRegisterDescription(offset=0x34),
    "NOC_ID_LOGICAL": NocConfigurationRegisterDescription(offset=0x38),
...
default_niu_register_store_noc0_initialization = get_niu_register_store_initialization(
    DeviceAddress(noc_address=0xFFB20000, noc_id=NocId.NOC0)
)
default_niu_register_store_noc1_initialization = get_niu_register_store_initialization(
    DeviceAddress(noc_address=0xFFB20000, noc_id=NocId.NOC1)
)
