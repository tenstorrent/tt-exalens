...
debug_bus_signal_map = {
    ...
    "adcs2_packers_channel1_x_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=6, sig_sel=5, mask=0xFFFC0000),
    "adcs2_packers_channel1_x_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=6, sig_sel=5, mask=0xF),
    ...
    "adcs2_packers_channel0_x_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=6, sig_sel=4, mask=0xFFFC0000),
    "adcs2_packers_channel0_x_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=6, sig_sel=4, mask=0xF),
    ...
    "adcs0_unpacker1_channel1_x_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=6, sig_sel=3, mask=0xFFFC0000),
    "adcs0_unpacker1_channel1_x_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=6, sig_sel=3, mask=0xF),
    ...
    "adcs0_unpacker1_channel0_x_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=6, sig_sel=2, mask=0xFFFC0000),
    "adcs0_unpacker1_channel0_x_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=6, sig_sel=2, mask=0xF),
    ...
    "adcs0_unpacker0_channel1_x_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=6, sig_sel=1, mask=0xFFFC0000),
    "adcs0_unpacker0_channel1_x_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=6, sig_sel=1, mask=0xF),
    ...
    "adcs0_unpacker0_channel0_x_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=6, sig_sel=0, mask=0xF),
    "adcs0_unpacker0_channel0_x_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=6, sig_sel=0, mask=0xFFFC0000),
    ...
    # "rwc_i_dest_target_reg_cfg_math_offset": DebugBusSignalDescription(   # Duplicate signal name - not same width
    ...
    "rwc_i_opcode": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=0, mask=0x1FE0000),
    # "rwc_i_instrn_payload": DebugBusSignalDescription(  # Duplicate signal name - not same width
    #     rd_sel=1, daisy_sel=3, sig_sel=0, mask=0xFE000000
    # ),
    # "rwc_i_instrn_payload": DebugBusSignalDescription(  # Duplicate signal name - not same width
    #     rd_sel=2, daisy_sel=3, sig_sel=0, mask=0x1FFFF
    # ),
    # "rwc_i_opcode": DebugBusSignalDescription(  # Duplicate signal name - not same width
    ...
    # ),
    "rwcs0_dst_cr": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=2, mask=0x3FF0000),
    "rwcs0_dst": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=2, mask=0x3FF),
    "rwcs2_srcb_cr": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=2, mask=0x3F000000),
    "rwcs2_srcb": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=2, mask=0x3F0000),
    "rwcs1_srcb_cr": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=2, mask=0x3F00),
    "rwcs1_srcb": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=2, mask=0x3F),
    "rwcs0_srcb_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=2, mask=0x3F000000),
    "rwcs0_srcb": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=2, mask=0x3F0000),
    "rwcs2_srca_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=2, mask=0x3F00),
    "rwcs2_srca": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=2, mask=0x3F),
    "rwcs1_srca_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=2, mask=0x3F000000),
    "rwcs1_srca": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=2, mask=0x3F0000),
    "rwcs0_srca_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=2, mask=0x3F00),
    "rwcs0_srca": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=2, mask=0x3F),
    "rwcs2_dst_cr": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=3, mask=0x3FF0000),
    "rwcs2_dst": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=3, mask=0x3FF),
    "rwcs1_dst_cr": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=3, mask=0x3FF0000),
    "rwcs1_dst": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=3, mask=0x3FF),
    "rwcs2_fidelity_phase": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=4, mask=0xC0000000),
    "rwcs1_fidelity_phase": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=4, mask=0x30000000),
    "rwcs0_fidelity_phase": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=4, mask=0xC000000),
    ...
    "l1_access_port_l1_addr_p18": DebugBusSignalDescription(rd_sel=2, daisy_sel=8, sig_sel=5, mask=0x1FFFF0),
    "l1_access_port_l1_addr_p17/1": DebugBusSignalDescription(rd_sel=2, daisy_sel=8, sig_sel=5, mask=0xF),
    "l1_access_port_l1_addr_p17/0": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=5, mask=0xFFF80000),
    "l1_access_port_l1_addr_p16": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=5, mask=0x7FFFC),
    "l1_access_port_l1_addr_p15": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=5, mask=0x3),
    "l1_access_port_l1_addr_p14": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=5, mask=0xFFFE0000),
    "l1_access_port_l1_addr_p13": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=5, mask=0x1FFFF),
    ...
    "l1_access_port_l1_addr_p12/1": DebugBusSignalDescription(rd_sel=2, daisy_sel=8, sig_sel=3, mask=0xFFF),
    "l1_access_port_l1_addr_p12/0": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=3, mask=0xF8000000),
    "l1_access_port_l1_addr_p11": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=3, mask=0x7FFFC00),
    "l1_access_port_l1_addr_p10/1": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=3, mask=0x3FF),
    "l1_access_port_l1_addr_p10/0": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=3, mask=0xFE000000),
    "l1_access_port_l1_addr_p9": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=3, mask=0x1FFFF00),
    "l1_access_port_l1_addr_p8": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=3, mask=0xFF),
    "l1_access_port_l1_addr_p7": DebugBusSignalDescription(rd_sel=3, daisy_sel=8, sig_sel=2, mask=0xFF800000),
    "l1_access_port_l1_addr_p6": DebugBusSignalDescription(rd_sel=3, daisy_sel=8, sig_sel=2, mask=0x7FFFC0),
    "l1_access_port_l1_addr_p5/1": DebugBusSignalDescription(rd_sel=3, daisy_sel=8, sig_sel=2, mask=0x3F),
    "l1_access_port_l1_addr_p5/0": DebugBusSignalDescription(rd_sel=2, daisy_sel=8, sig_sel=2, mask=0xFFE00000),
    "l1_access_port_l1_addr_p4": DebugBusSignalDescription(rd_sel=2, daisy_sel=8, sig_sel=2, mask=0x1FFFF0),
    "l1_access_port_l1_addr_p3/1": DebugBusSignalDescription(rd_sel=2, daisy_sel=8, sig_sel=2, mask=0xF),
    "l1_access_port_l1_addr_p3/0": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=2, mask=0xFFF80000),
    "l1_access_port_l1_addr_p2": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=2, mask=0x7FFFC),
    "l1_access_port_l1_addr_p1/1": DebugBusSignalDescription(rd_sel=1, daisy_sel=8, sig_sel=2, mask=0x3),
    "l1_access_port_l1_addr_p1/0": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=2, mask=0xFFFE0000),
    "l1_access_port_l1_addr_p0": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=2, mask=0x1FFFF),
