...
register_map: dict[str, RegisterDescription] = {
    ...
    # https://github.com/tenstorrent/tt-metal/blob/main/tt_metal/tt-llk/tt_llk_wormhole_b0/common/inc/ckernel_gpr_map.h
    # THREAD 0
    ...
    "RISCV_DEBUG_REG_PERF_CNT_INSTRN_THREAD0": DebugRegisterDescription(offset=0x000),
    ...
    "RISCV_DEBUG_REG_PERF_CNT_TDMA_UNPACK0": DebugRegisterDescription(offset=0x00C),
    "RISCV_DEBUG_REG_PERF_CNT_TDMA_UNPACK1": DebugRegisterDescription(offset=0x010),
    "RISCV_DEBUG_REG_PERF_CNT_TDMA_UNPACK2": DebugRegisterDescription(offset=0x014),
    ...
    "RISCV_DEBUG_REG_CFGREG_RD_CNTL": DebugRegisterDescription(offset=0x058),
    ...
    "RISCV_DEBUG_REG_CFGREG_RDDATA": DebugRegisterDescription(offset=0x078),
    ...
    "RISCV_DEBUG_REG_PERF_CNT_TDMA_PACK0": DebugRegisterDescription(offset=0x0F0),
    "RISCV_DEBUG_REG_PERF_CNT_TDMA_PACK1": DebugRegisterDescription(offset=0x0F4),
    "RISCV_DEBUG_REG_PERF_CNT_TDMA_PACK2": DebugRegisterDescription(offset=0x0F8),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_L_INSTRN_THREAD": DebugRegisterDescription(offset=0x100),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_H_INSTRN_THREAD": DebugRegisterDescription(offset=0x104),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_L_TDMA_UNPACK": DebugRegisterDescription(offset=0x108),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_H_TDMA_UNPACK": DebugRegisterDescription(offset=0x10C),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_L_TDMA_PACK": DebugRegisterDescription(offset=0x110),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_H_TDMA_PACK": DebugRegisterDescription(offset=0x114),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_L_DBG_L1": DebugRegisterDescription(offset=0x118),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_H_DBG_L1": DebugRegisterDescription(offset=0x11C),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_L_FPU": DebugRegisterDescription(offset=0x120),
    "RISCV_DEBUG_REG_PERF_CNT_OUT_H_FPU": DebugRegisterDescription(offset=0x124),
    "RISCV_DEBUG_REG_SOFT_RESET_0": DebugRegisterDescription(offset=0x1B0),
    "RISCV_DEBUG_REG_BREAKPOINT_CTRL": DebugRegisterDescription(offset=0x1C0),
    "RISCV_DEBUG_REG_BREAKPOINT_STATUS": DebugRegisterDescription(offset=0x1C4),
    "RISCV_DEBUG_REG_BREAKPOINT_DATA": DebugRegisterDescription(offset=0x1C8),
    "RISCV_DEBUG_REG_WDT": DebugRegisterDescription(offset=0x1E0),
    ...
    "RISCV_DEBUG_REG_WALL_CLOCK_L": DebugRegisterDescription(offset=0x1F0),
    "RISCV_DEBUG_REG_WALL_CLOCK_H": DebugRegisterDescription(offset=0x1F8),
    "RISCV_DEBUG_REG_TIMESTAMP": DebugRegisterDescription(offset=0x1FC),
    "RISCV_DEBUG_REG_TIMESTAMP_STATUS": DebugRegisterDescription(offset=0x204),
