...
register_map: dict[str, RegisterDescription] = {
    ...
    # THREAD 0
    "ZERO_T0": GeneralPurposeRegisterDescription(index=0, thread_id=0),
    ...
    "ZERO_1_T0": GeneralPurposeRegisterDescription(index=9, thread_id=0),
    "ZERO_2_T0": GeneralPurposeRegisterDescription(index=10, thread_id=0),
    "ZERO_3_T0": GeneralPurposeRegisterDescription(index=11, thread_id=0),
    "TMP0_T0": GeneralPurposeRegisterDescription(index=12, thread_id=0),
    "TMP1_T0": GeneralPurposeRegisterDescription(index=13, thread_id=0),
    ...
    "PERF_FIRST_UNP_LO_T0": GeneralPurposeRegisterDescription(index=32, thread_id=0),
    "PERF_FIRST_UNP_HI_T0": GeneralPurposeRegisterDescription(index=33, thread_id=0),
    ...
    "TILE_SIZE_A_T0": GeneralPurposeRegisterDescription(index=36, thread_id=0),
    "TILE_SIZE_B_T0": GeneralPurposeRegisterDescription(index=37, thread_id=0),
    "KT_DIM_T0": GeneralPurposeRegisterDescription(index=38, thread_id=0),
    "GPR_T0_39": GeneralPurposeRegisterDescription(index=39, thread_id=0),
    "FACE_DIM_16x16_T0": GeneralPurposeRegisterDescription(index=40, thread_id=0),
    "FACE_DIM_8x16_T0": GeneralPurposeRegisterDescription(index=41, thread_id=0),
    "FACE_DIM_4x16_T0": GeneralPurposeRegisterDescription(index=42, thread_id=0),
    "FACE_DIM_2x16_T0": GeneralPurposeRegisterDescription(index=43, thread_id=0),
    "FACE_DIM_1x16_T0": GeneralPurposeRegisterDescription(index=44, thread_id=0),
    "PERF_UNPACK_NUM_TILES_0_T0": GeneralPurposeRegisterDescription(index=45, thread_id=0),
    "PERF_UNPACK_NUM_TILES_1_T0": GeneralPurposeRegisterDescription(index=46, thread_id=0),
    "PERF_UNPACK_NUM_TILES_2_T0": GeneralPurposeRegisterDescription(index=47, thread_id=0),
    "PERF_UNPACK_NUM_TILES_3_T0": GeneralPurposeRegisterDescription(index=48, thread_id=0),
    ...
    "UNPACK_STRIDE_T0": GeneralPurposeRegisterDescription(index=52, thread_id=0),
    "GPR_T0_53": GeneralPurposeRegisterDescription(index=53, thread_id=0),
    "SR_UNPACK_TILIZER_STATE_0_T0": GeneralPurposeRegisterDescription(index=54, thread_id=0),
    "SR_UNPACK_TILIZER_STATE_1_T0": GeneralPurposeRegisterDescription(index=55, thread_id=0),
    "SR_UNPACK_UNTILIZER_STATE_0_T0": GeneralPurposeRegisterDescription(index=56, thread_id=0),
    "SR_UNPACK_UNTILIZER_STATE_1_T0": GeneralPurposeRegisterDescription(index=57, thread_id=0),
    "SR_UNPACK_UNTILIZER_STATE_2_T0": GeneralPurposeRegisterDescription(index=58, thread_id=0),
    "SR_UNPACK_UNTILIZER_STATE_3_T0": GeneralPurposeRegisterDescription(index=59, thread_id=0),
    ...
    # THREAD 1
    "ZERO_T1": GeneralPurposeRegisterDescription(index=0, thread_id=1),
    "DBG_RESERVED_T1": GeneralPurposeRegisterDescription(index=1, thread_id=1),
    "DBG_MSG_T1": GeneralPurposeRegisterDescription(index=2, thread_id=1),
    "DBG_CKID_T1": GeneralPurposeRegisterDescription(index=3, thread_id=1),
    "PERF_DBUS_CNTL_T1": GeneralPurposeRegisterDescription(index=4, thread_id=1),
    "PERF_MEM_DUMP_CNTL_CLEAR_T1": GeneralPurposeRegisterDescription(index=5, thread_id=1),
    ...
    "DEST_OP0_BASE_T1": GeneralPurposeRegisterDescription(index=48, thread_id=1),
    "DEST_OP1_BASE_T1": GeneralPurposeRegisterDescription(index=49, thread_id=1),
    "DEST_REGW_OFFSET_T1": GeneralPurposeRegisterDescription(index=50, thread_id=1),
    "DEST_REGW_INCR_T1": GeneralPurposeRegisterDescription(index=51, thread_id=1),
    "DEST_REGW_OFFSET2_T1": GeneralPurposeRegisterDescription(index=52, thread_id=1),
    "DEST_REGW_INCR2_T1": GeneralPurposeRegisterDescription(index=53, thread_id=1),
    ...
    "TMP0_T1": GeneralPurposeRegisterDescription(index=60, thread_id=1),
    "NUM_DRAM_REQS_T1": GeneralPurposeRegisterDescription(index=61, thread_id=1),
    ...
    # THREAD 2
    "ZERO_T2": GeneralPurposeRegisterDescription(index=0, thread_id=2),
    "DBG_RESERVED_T2": GeneralPurposeRegisterDescription(index=1, thread_id=2),
    "DBG_MSG_T2": GeneralPurposeRegisterDescription(index=2, thread_id=2),
    "DBG_CKID_T2": GeneralPurposeRegisterDescription(index=3, thread_id=2),
    "DEST_OFFSET_LO_T2": GeneralPurposeRegisterDescription(index=4, thread_id=2),
    ...
    "DEST_OFFSET_HI_T2": GeneralPurposeRegisterDescription(index=8, thread_id=2),
    ...
    "TILE_HEADER_T2": GeneralPurposeRegisterDescription(index=16, thread_id=2),
    ...
    "TEMP_TILE_OFFSET_T2": GeneralPurposeRegisterDescription(index=20, thread_id=2),
    ...
    "TMP_LO_T2": GeneralPurposeRegisterDescription(index=30, thread_id=2),
    "TMP_HI_T2": GeneralPurposeRegisterDescription(index=31, thread_id=2),
    "PACK_STREAM_SYNC_T2": GeneralPurposeRegisterDescription(index=32, thread_id=2),
    ...
    "OUTPUT_ADDR_OFFSET_T2": GeneralPurposeRegisterDescription(index=50, thread_id=2),
    "PERF_PACK_NUM_TILES_T2": GeneralPurposeRegisterDescription(index=51, thread_id=2),
    "EXP0_SEC_SIZE_BFP_T2": GeneralPurposeRegisterDescription(index=52, thread_id=2),
    "EXP1_SEC_SIZE_BFP8_T2": GeneralPurposeRegisterDescription(index=53, thread_id=2),
    "EXP2_SEC_SIZE_BFP8_T2": GeneralPurposeRegisterDescription(index=54, thread_id=2),
    "EXP3_SEC_SIZE_BFP8_T2": GeneralPurposeRegisterDescription(index=55, thread_id=2),
    "GPR_T2_56": GeneralPurposeRegisterDescription(index=56, thread_id=2),
    "EXP1_SEC_SIZE_BFP4_T2": GeneralPurposeRegisterDescription(index=57, thread_id=2),
    "EXP2_SEC_SIZE_BFP4_T2": GeneralPurposeRegisterDescription(index=58, thread_id=2),
    "EXP3_SEC_SIZE_BFP4_T2": GeneralPurposeRegisterDescription(index=59, thread_id=2),
    "GPR_T2_60": GeneralPurposeRegisterDescription(index=60, thread_id=2),
    "EXP1_SEC_SIZE_BFP2_T2": GeneralPurposeRegisterDescription(index=61, thread_id=2),
    "EXP2_SEC_SIZE_BFP2_T2": GeneralPurposeRegisterDescription(index=62, thread_id=2),
    "EXP3_SEC_SIZE_BFP2_T2": GeneralPurposeRegisterDescription(index=63, thread_id=2),
    # REST
...
def get_general_purpose_registers() -> list[dict[str, str]]:
    register_by_thread: list[dict[str, str]] = [dict() for _ in range(3)]
    for register_name in register_map.keys():
        ...
        if register_name.endswith("_T0") or register_name.endswith("_T1") or register_name.endswith("_T2"):
            register_by_thread[int(register_name[-1])][register_name[:-3].lower()] = register_name
        else:
            register_by_thread[int(register_name[5])][f"Index: {register_name[7:]}"] = register_name

    return register_by_thread
