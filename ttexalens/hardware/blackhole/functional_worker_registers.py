...
register_map: dict[str, RegisterDescription] = {
    ...
    "RISCV_DEBUG_REG_LFSR_HIT_MASK": DebugRegisterDescription(offset=0x220),
    "RISCV_DEBUG_REG_DISABLE_RESET": DebugRegisterDescription(offset=0x224),
    ...
    "RISCV_DEBUG_REG_CG_CTRL_EN": DebugRegisterDescription(offset=0x244),
    "RISCV_DEBUG_REG_CG_KICK": DebugRegisterDescription(offset=0x248),
}
