...
debug_bus_signal_map = {
    ...
    # "tensix_frontend_t0_prev_gen_no/0": DebugBusSignalDescription(        # Duplicate signal name - not same width
    #     rd_sel=3, daisy_sel=1, sig_sel=12, mask=0xF0000000
    # ),
    # "tensix_frontend_t0_prev_gen_no/1": DebugBusSignalDescription(        # Duplicate signal name - not same width
    ...
    # "tensix_frontend_t1_prev_gen_no/0": DebugBusSignalDescription(        # Duplicate signal name - not same width
    #     rd_sel=3, daisy_sel=1, sig_sel=8, mask=0xF0000000
    # ),
    # "tensix_frontend_t1_prev_gen_no/1": DebugBusSignalDescription(        # Duplicate signal name - not same width
    ...
    # "tensix_frontend_t2_prev_gen_no/0": DebugBusSignalDescription(              # Duplicate signal name - not same width
    #     rd_sel=3, daisy_sel=1, sig_sel=4, mask=0xF0000000
    # ),
    # "tensix_frontend_t2_prev_gen_no/1": DebugBusSignalDescription(              # Duplicate signal name - not same width
    ...
    "rwcs_math_instrn/0": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=7, mask=0xFFFFF800),
    "rwcs_math_instrn/1": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=7, mask=0x7FF),
    "rwcs_math_winner_thread": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=7, mask=0x600),
    "rwcs_math_winner": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=7, mask=0x1C0),
    "rwcs_s0_fidelity_phase_d": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=7, mask=0x30),
    "rwcs_s0_srca_reg_addr_d/0": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=7, mask=0xC0000000),
    "rwcs_s0_srca_reg_addr_d/1": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=7, mask=0xF),
    "rwcs_s0_srcb_reg_addr_d": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=7, mask=0x3F000000),
    "rwcs_s0_dst_reg_addr_d": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=7, mask=0xFFC000),
    "rwcs_s0_mov_dst_reg_addr_d": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=7, mask=0x3FF0),
    "rwcs_s0_dec_instr_single_output_row_d": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=7, mask=0x8),
    "rwcs_fpu_rd_data_required_d": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=7, mask=0x7),
    "rwcs_tdma_srca_unpack_src_reg_set_upd": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=6, mask=0x10),
    "rwcs_debug_issue0_in_3_dma_srca_wr_port_avail": DebugBusSignalDescription(
        rd_sel=3, daisy_sel=3, sig_sel=6, mask=0x8
    ),
    "rwcs_debug_issue0_in_3_srca_write_ready": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=6, mask=0x4),
    "rwcs_tdma_srca_unpack_if_sel": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=6, mask=0x2),
    "rwcs_tdma_srca_regif_state_id": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=6, mask=0x1),
    "rwcs_tdma_srca_regif_addr": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=6, mask=0xFFFC0000),
    "rwcs_tdma_srca_regif_wren": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=6, mask=0x3C000),
    "rwcs_tdma_srca_regif_thread_id": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=6, mask=0x3000),
    "rwcs_tdma_srca_regif_out_data_format": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=6, mask=0xF00),
    "rwcs_tdma_srca_regif_data_format": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=6, mask=0xF0),
    "rwcs_tdma_srca_regif_shift_amount": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=6, mask=0xF),
    "rwcs_tdma_srcb_unpack_src_reg_set_upd": DebugBusSignalDescription(
        rd_sel=1, daisy_sel=3, sig_sel=6, mask=0x80000000
    ),
    "rwcs_debug_issue0_in_3_dmac_srcb_wr_port_avail": DebugBusSignalDescription(
        rd_sel=1, daisy_sel=3, sig_sel=6, mask=0x40000000
    ),
    "rwcs_debug_issue0_in_3_srcb_write_ready": DebugBusSignalDescription(
        rd_sel=1, daisy_sel=3, sig_sel=6, mask=0x20000000
    ),
    "rwcs_tdma_srcb_regif_state_id": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=6, mask=0x10000000),
    "rwcs_tdma_srcb_regif_addr": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=6, mask=0xFFFC000),
    "rwcs_tdma_srcb_regif_wren": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=6, mask=0x3C00),
    "rwcs_tdma_srcb_regif_thread_id": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=6, mask=0x300),
    "rwcs_tdma_srcb_regif_out_data_format": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=6, mask=0xF0),
    "rwcs_tdma_srcb_regif_data_format": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=6, mask=0xF),
    "rwcs_tdma_dstac_regif_rden_raw": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=6, mask=0x80),
    "rwcs_tdma_dstac_regif_thread_id": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=6, mask=0x60),
    "rwcs_tdma_dstac_regif_data_format": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=6, mask=0x1E),
    "rwcs_dstac_regif_tdma_reqif_ready": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=6, mask=0x1),
    "rwcs_tdma_pack_busy": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=5, mask=0x1000),
    "rwcs_tdma_unpack_busy": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=5, mask=0xFC0),
    "rwcs_tdma_tc_busy": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=5, mask=0x38),
    "rwcs_tdma_move_busy": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=5, mask=0x4),
    "rwcs_tdma_xsearch_busy/0": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0xF0000000),
    "rwcs_tdma_xsearch_busy/1": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=5, mask=0x3),
    "rwcs_i_cg_regblocks_en": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0x2000000),
    "rwcs_cg_regblocks_busy_d": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0x1000000),
    "rwcs_srcb_reg_addr": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0xF80000),
    "rwcs_srcb_reg_addr_d": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0x7C000),
    "rwcs_fpu_output_mode_d": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0x3800),
    "rwcs_fpu_output_mode": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0x700),
    "rwcs_srcb_single_row_rd_mode_d": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0x80),
    "rwcs_srcb_single_row_rd_mode": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=5, mask=0x40),
    "rwcs_dest_apply_relu": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=5, mask=0x60),
    "rwcs_tdma_dstac_regif_state_id": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=5, mask=0x10),
    # "rwcs_relu_thresh/0": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=4, mask=0xFFF00000),        # Duplicate signal name - not same width
    # "rwcs_relu_thresh/1": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=5, mask=0xF),              # Duplicate signal name - not same width
    "rwcs_dest_offset_state_id": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=4, mask=0x80000),
    "rwcs_dma_dest_offset_apply_en": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=4, mask=0x40000),
    "rwcs_srca_fpu_output_alu_s1": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=4, mask=0x3C000),
    "rwcs_srcb_fpu_output_alu_s1": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=4, mask=0x3C00),
    "rwcs_dest_fpu_output_alu_s1": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=4, mask=0x3C0),
    "rwcs_dest_dma_output_alu": DebugBusSignalDescription(rd_sel=3, daisy_sel=3, sig_sel=4, mask=0x3C),
    "rwcs_srca_gate_src_pipeline_0": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x10000000),
    "rwcs_srca_gate_src_pipeline_1": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x8000000),
    "rwcs_srcb_gate_src_pipeline_0": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x4000000),
    "rwcs_srcb_gate_src_pipeline_1": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x2000000),
    "rwcs_squash_alu_instrn": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x1000000),
    "rwcs_alu_instr_issue_ready": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x800000),
    "rwcs_alu_instr_issue_ready_src": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x400000),
    "rwcs_sfpu_instr_issue_ready_s1": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x200000),
    "rwcs_sfpu_instr_store_ready_s1": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x100000),
    "rwcs_lddest_instr_valid": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x80000),
    "rwcs_rddest_instr_valid": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x40000),
    "rwcs_dest_reg_deps_scoreboard_bank_pending": DebugBusSignalDescription(
        rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x30000
    ),
    "rwcs_dest_reg_deps_scoreboard_something_pending": DebugBusSignalDescription(
        rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x8000
    ),
    "rwcs_dest_reg_deps_scoreboard_pending_thread": DebugBusSignalDescription(
        rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x7000
    ),
    "rwcs_all_buffers_empty": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0xE00),
    "rwcs_dest_reg_deps_scoreboard_stall": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x100),
    "rwcs_dest_wr_port_stall": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x80),
    "rwcs_dest_fpu_rd_port_stall": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x40),
    "rwcs_dest2src_post_stall": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x20),
    "rwcs_post_shiftxb_stall": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x10),
    "rwcs_dest2src_dest_stall": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x8),
    "rwcs_post_alu_instr_stall": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x4),
    "rwcs_fidelity_phase_cnt/0": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=4, mask=0xF0000000),
    "rwcs_fidelity_phase_cnt/1": DebugBusSignalDescription(rd_sel=2, daisy_sel=3, sig_sel=4, mask=0x3),
    "rwcs_math_instrn": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=4, mask=0xC000000),
    "rwcs_math_winner_thread/0": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=4, mask=0xFC000000),
    "rwcs_math_winner_thread/1": DebugBusSignalDescription(rd_sel=1, daisy_sel=3, sig_sel=4, mask=0x3FFFFFF),
    "rwcs_s0_srca_reg_addr": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=4, mask=0x1F80000),
    "rwcs_s0_srcb_reg_addr": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=4, mask=0x7E000),
    "rwcs_s0_dst_reg_addr": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=4, mask=0x1FF8),
    "rwcs_s0_fidelity_phase": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=4, mask=0x6),
    "rwcs_s0_dec_instr_single_output_row": DebugBusSignalDescription(rd_sel=0, daisy_sel=3, sig_sel=4, mask=0x1),
    ...
    "rwc_debug_daisy_stop_issue0_debug_issue0_in[0]_dup": DebugBusSignalDescription(
    ...
    # "adcs_dest_sfpu_wr_en/0": DebugBusSignalDescription(rd_sel=3, daisy_sel=6, sig_sel=10, mask=0xFE000000),  # Duplicate signal name - not same width
    # "adcs_dest_sfpu_wr_en/1": DebugBusSignalDescription(rd_sel=0, daisy_sel=6, sig_sel=11, mask=0x1),     # Duplicate signal name - not same width
    ...
    # "adcs_i_pack_req_dest_ds_mask/0": DebugBusSignalDescription(rd_sel=2, daisy_sel=6, sig_sel=8, mask=0xF0000000),   # Duplicate signal name - not same width
    # "adcs_i_pack_req_dest_ds_mask/1": DebugBusSignalDescription(rd_sel=3, daisy_sel=6, sig_sel=8, mask=0xFFFFFFFF),   # Duplicate signal name - not same width
    # "adcs_i_pack_req_dest_ds_mask/2": DebugBusSignalDescription(rd_sel=0, daisy_sel=6, sig_sel=9, mask=0xFFFFFFF),    # Duplicate signal name - not same width
    ...
    # "l1_addr_p38/1": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=13, mask=0x7FFF),       # Duplicate signal name - not same width
    # "l1_addr_p38/0": DebugBusSignalDescription(rd_sel=3, daisy_sel=8, sig_sel=11, mask=0xC0000000),   # Duplicate signal name - not same width
    ...
    # "l1_addr_p30/0": DebugBusSignalDescription(rd_sel=3, daisy_sel=8, sig_sel=10, mask=0xFFC00000),       # Duplicate signal name - not same width
    # "l1_addr_p30/1": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=11, mask=0x7F),     # Duplicate signal name - not same width
    ...
    # "l1_addr_p23/1": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=10, mask=0xFFFF),    # Duplicate signal name - not same width
    # "l1_addr_p23/0": DebugBusSignalDescription(rd_sel=3, daisy_sel=8, sig_sel=9, mask=0x80000000),  # Duplicate signal name - not same width
    ...
    # "l1_addr_p15/0": DebugBusSignalDescription(rd_sel=3, daisy_sel=8, sig_sel=8, mask=0xFF800000),   # Duplicate signal name - not same width
    # "l1_addr_p15/1": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=9, mask=0xFF),          # Duplicate signal name - not same width
    ...
    # "l1_addr_p0/0": DebugBusSignalDescription(rd_sel=3, daisy_sel=8, sig_sel=6, mask=0xC0000000),     # Duplicate signal name - not same width
    # "l1_addr_p0/1": DebugBusSignalDescription(rd_sel=0, daisy_sel=8, sig_sel=7, mask=0x7FFF),         # Duplicate signal name - not same width
    ...
    # "packed_data_p5/0": DebugBusSignalDescription(rd_sel=3, daisy_sel=14, sig_sel=4, mask=0xFFFFFFF0),        # Duplicate signal name - not same width
    # "packed_data_p5/1": DebugBusSignalDescription(rd_sel=0, daisy_sel=14, sig_sel=5, mask=0xFFFFFFFF),        # Duplicate signal name - not same width
    # "packed_data_p5/2": DebugBusSignalDescription(rd_sel=1, daisy_sel=14, sig_sel=5, mask=0x3),               # Duplicate signal name - not same width
...
group_map: dict[str, tuple[int, int]] = {
    ...
    "instrn_thread_stall_perf_counters": (1, 1),
    "instrn_thread_grant_perf_counters": (1, 2),
    "instrn_thread_grant_stall_perf_counters": (1, 3),
    "tensix_frontend_t2": (1, 4),
    "tensix_frontend_t2_stall_signals": (1, 5),
    "instrn_thread_grant_stall_perf_counters0": (1, 6),
    "instrn_thread_rsn_thcon_grant_stall_perf_counters": (1, 7),
    "tensix_frontend_t1": (1, 8),
    "tensix_frontend_perf_counters": (1, 9),
    "instrn_thread_grant_stall_perf_counters1": (1, 10),
    "instrn_thread_grant_stall_perf_counters2": (1, 11),
    ...
    "rwcs_pack_unpack_signals": (3, 5),
    "rwcs_tdma_core_signals": (3, 6),
    "rwcs_math_pipeline": (3, 7),
    # Issue debug performance counters from 8 to 18 (DaisySel == 4)
    "instrn_thread_issue_dbg8_perf_counters": (4, 2),
    "instrn_thread_issue_dbg9_perf_counters": (4, 4),
    "instrn_thread_issue_dbg10_perf_counters": (4, 6),
    "instrn_thread_issue_dbg11_perf_counters": (4, 8),
    "instrn_thread_issue_dbg12_perf_counters": (4, 10),
    "instrn_thread_issue_dbg13_perf_counters": (4, 12),
    "instrn_thread_issue_dbg14_perf_counters": (4, 14),
    "instrn_thread_issue_dbg15_perf_counters": (4, 16),
    "instrn_thread_issue_dbg16_perf_counters": (4, 18),
    "instrn_thread_issue_dbg17_perf_counters": (4, 20),
    "instrn_thread_issue_dbg18_perf_counters": (4, 22),
    # UIssue debug performance counters from 0 to 7 (DaisySel == 5)
    "instrn_thread_issue_dbg0_perf_counters": (5, 0),
    "instrn_thread_issue_dbg1_perf_counters": (5, 2),
    "instrn_thread_issue_dbg2_perf_counters": (5, 4),
    "instrn_thread_issue_dbg3_perf_counters": (5, 6),
    "instrn_thread_issue_dbg4_perf_counters": (5, 8),
    "instrn_thread_issue_dbg5_perf_counters": (5, 10),
    "instrn_thread_issue_dbg6_perf_counters": (5, 12),
    "instrn_thread_issue_dbg7_perf_counters": (5, 14),
