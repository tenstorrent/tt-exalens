...
from ttexalens.hardware.quasar.functional_neo_registers import tensix_registers_descriptions
...
class QuasarDevice(Device):
    ...
    def get_tensix_registers_description(self) -> QuasarTensixRegisterDescription:
